export const backgroundImage = {
  gradient1: 'linear-gradient(0deg, rgba(255,255,255,1) 0%, rgba(197,229,255,1) 100%)',
  gradient2: 'linear-gradient(90deg, rgba(252,243,255,1) 0%, rgba(182,207,255,1) 100%)',
  ...
  darkGradient1: 'linear-gradient(180deg, rgba(3, 3, 3, 0.48) 0%, rgba(3, 3, 3, 0.80) 100%)',
};
